...
def creamenus(surface):
    ...
    menu3.add.button('Sumes amb imatges',jugarimatges, font_name=font1, font_color='blue')
    ...
    menu5.add.button('Multiplicacions dictades', font_name=font1, font_color='yellow')

    # Make menu Divisions
    menu6 = pygame_menu.Menu('Divisions', 600, 400,
                             theme=pygame_menu.themes.THEME_GREEN)

    menu6.add.button('Divisions infinites',jugar,"DIVISIO", font_name=font1, font_color='green')
    ...
    # Make main menu
    main_menu = pygame_menu.Menu('Projecte MatZanfe', 600, 400,
                            theme=pygame_menu.themes.THEME_SOLARIZED)
