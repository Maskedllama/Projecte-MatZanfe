...
imageaudio3 = pygame.image.load("ClickAudio3.png").convert()
# esto lo vas a necesitar para detectar el click
image_position = (190, 70)
image_size = imageaudio3.get_rect().size
...
def main():
    ...
    surface.blit(imageaudio3, image_position)

    punts = font.render("Puntuació: " + str(points), True, (255, 255, 255))
    surface.blit(punts, (350, 30))
    titolmultiplicacio3 = font.render("Multiplicació (3)", True, (0, 0, 0))
    surface.blit(titolmultiplicacio3, (10, 20))
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            if image_position[0] < click[0] < image_position[0] + image_size[0] and image_position[1] < click[1] < \
                ...
                mixer.music.load("AudioMultplicacio.wav")
                mixer.music.play(1)
