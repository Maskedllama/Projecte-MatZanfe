...
imageaudio2 = pygame.image.load("ClickAudio2.png").convert()
# esto lo vas a necesitar para detectar el click
image_position = (190, 70)
image_size = imageaudio2.get_rect().size
...
def main():
    ...
    surface.blit(imageaudio2, image_position)

    punts = font.render("Puntuació: " + str(points), True, (255, 255, 255))
    surface.blit(punts, (350, 30))
    titolresta3 = font.render("Resta (3)", True, (0, 0, 0))
    surface.blit(titolresta3, (10, 20))
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            if image_position[0] < click[0] < image_position[0] + image_size[0] and image_position[1] < click[1] < \
                ...
                #Aquest àudio és provisional
                mixer.music.load("AudioResta.wav")
                mixer.music.play(1)
